...
import 'package:dlog/features/shippment_order/presentation/screens/view/items/tracking.dart';
          ...
          Expanded(
            ...
            children: [
              ...
              10.spacingHeight,
                    Row(
                      children: [
                        Flexible(child: DLogText("Yangon", style: context.getTextTheme.secondaryMedium,color: context.getColorScheme.blackColor,)),
                        4.spacingWidth,
                        const Tracking(),
                        4.spacingWidth,
                        Flexible(child: DLogText("Mandalay", style: context.getTextTheme.secondaryMedium,color: context.getColorScheme.blackColor,)),
                      ],
                    )
            ],
          ))
