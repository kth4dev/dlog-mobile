...
class SupplierCodeAndDetailFileItem extends StatelessWidget {
  final String label;
  final String hintText;
  final String icon;
  final VoidCallback onTap;
  const SupplierCodeAndDetailFileItem({super.key,required this.icon,required this.label,required this.hintText,required this.onTap});
